...
def main(data_dir):
    ...
    for frame_ids in range(int(starting_frame), len(free)-2):
        ...
        # initial state
        c_speed = 15.0 / 3.6  # current speed [m/s]
        ...
        for i in range(1):
            ...
            if show_animation:  # pragma: no cover
                ...
                print("1 = ", path.x[1] - area, path)
                print("2 = ", path.x[1] + area)
                ...
                print("major_ticks2 = ", major_ticks2)
        ...
        wx[0] = path.x[1]
        wy[0] = path.y[1]
        #print("xxx = ", path.x[1], "  yyy = ", path.y[1])
